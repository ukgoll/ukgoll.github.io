...
在 [kqueue-learn](./2025-03-01-kqueue-learn.md)，我们已经了解过，select 的一些缺点；在用户态和内核态切换太频繁，以及 `select` 在本身结构上，无法保存 client 和 server 的信息，使用起来比较麻烦，还得是 **kqueue** 以及 **epoll** 这种高级一点 IO 多路复用。
